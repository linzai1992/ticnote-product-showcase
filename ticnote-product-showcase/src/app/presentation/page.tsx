...
const slides = [
    ...
    features: [
      {
        ...
        name: '原文全文',
        title: '逐字逐句记录',
        description: '完整保留会议原话，包含讲话人标识和时间戳，方便后续查阅和引用',
        icon: '📄',
        color: 'blue',
        image: 'https://placehold.co/400x300?text=原文全文'
      },
      {
        id: 2,
        name: '纪要摘要',
        title: 'AI智能提炼',
        description: '自动提取会议核心内容，生成简洁摘要，快速把握会议重点',
        icon: '📝',
        color: 'green',
        image: 'https://placehold.co/400x300?text=纪要摘要'
      },
      {
        id: 3,
        name: '待办事项',
        title: '行动清单',
        description: '智能识别会议中的任务分配和行动计划，自动生成待办清单',
        icon: '✅',
        color: 'purple',
        image: 'https://placehold.co/400x300?text=待办事项'
      },
      {
        id: 4,
        name: '思维导图',
        title: '结构化呈现',
        description: '将会议内容转换为思维导图格式，层次分明，便于理解和记忆',
        icon: '🗺️',
        color: 'orange',
      ...
      },
      {
        ...
        name: '关键决策',
        title: '决策点追踪',
        description: '自动标记会议中的重要决策和讨论结论，方便后续跟进执行',
        icon: '🎯',
        color: 'red',
        image: 'https://placehold.co/400x300?text=关键决策'
      },
      {
        id: 6,
        name: '发言统计',
        title: '参与度分析',
        description: '统计每个人的发言时长和次数，分析会议参与度和话题分布',
        icon: '📊',
        color: 'teal',
  ...
  },
  {
    ...
    evolution: {
      dimensions: [
        { icon: '📱', name: '形态演进', desc: '卡片→耳机→手表' },
        { icon: '🧠', name: 'AI升级', desc: '转写→分析→决策' },
        { icon: '🌐', name: '场景扩展', desc: '会议→学习→生活' },
        { icon: '👥', name: '用户群', desc: '个人→团队→企业' },
        { icon: '🔗', name: '生态整合', desc: '独立→互联→协同' },
        { icon: '⚡', name: '性能提升', desc: '快速→智能→预测' }
      ],
      products: [
        {
          name: 'TicNote',
          ...
          features: ['3mm超薄', 'Shadow AI', '25小时录音', '双模式切换'],
          specs: {
            material: '航空级铝合金',
            weight: '29g',
            thickness: '3mm',
        ...
        },
        {
          ...
          position: '入门产品',
          target: '学生、职场新人、日常用户',
          features: ['5.8mm纤薄', '自适应录音', '彩色外壳', '长续航'],
          specs: {
            material: '高强度塑胶',
            weight: '18g',
            thickness: '5.8mm',
        ...
        },
        {
          ...
          year: '2025 Q4',
          position: '创新产品',
          target: '移动办公、运动健身、多场景用户',
          features: ['4G联网', 'AI视图', '边听边记', '50小时待机'],
          specs: {
        ...
        },
        {
          ...
          year: '2026 Q1',
          position: '生态产品',
          target: '健康管理、运动监测、全天候AI助手',
          features: ['健康监测', 'AI建议', '语音交互', '全天续航'],
          specs: {
            health: '心率+血氧',
            ai: 'AI健康建议',
            recording: '20小时录音',
      ...
      opportunities: [
        {
          icon: '🤝',
          title: '渠道合作',
          desc: '与线上线下渠道伙伴共拓市场，共享增长红利'
        },
        {
          icon: '🔧',
          title: '技术集成',
          desc: '开放API接口，支持第三方应用与服务集成'
        },
        {
          icon: '🌐',
          title: '生态共建',
          desc: '共同构建AI录音生态，创造更多应用场景'
        }
      ],
      vision: {
        title: '共创AI时代的智能办公新生态',
        subtitle: 'Building the Future of Intelligent Work Together',
        highlights: [
          '开放平台 - 技术共享',
          '合作共赢 - 价值共创',
          '生态协同 - 创新共进',
                    ...
                    <div className="relative">
                      ...
                      <div className="w-16 h-24 bg-gradient-to-b from-yellow-300 to-yellow-400 rounded-lg relative shadow-lg">
                        ...
                        <div className="absolute bottom-2 left-0 right-0 text-center">
                          <span className="text-xs font-bold text-yellow-900">1TB</span>
                        </div>
                      </div>
                      {/* 存储进度指示器 */}
      ...
      case 'product_evolution':
        return (
          <div className="space-y-16">
            ...
            {/* 演进维度 */}
            <div className="grid lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-16">
